...
class BootStrap
{
  ...
  def init = { servletContext ->
    if (!Speciality.count())
    {
      ...
      new Vet(firstName: "Helen", lastName: "Leary").addToSpecialities(rad).save()
      new Vet(firstName: "Linda", lastName: "Douglas").addToSpecialities(sur).addToSpecialities(den).save()
      new Vet(firstName: "Rafael", lastName: "Ortega").addToSpecialities(sur).save()
      new Vet(firstName: "Henry", lastName: "Stevens").addToSpecialities(rad).save()
